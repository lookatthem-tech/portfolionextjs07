...
2. **Enable Single Sign-On (SAML 2.0)**  
   ...
   ![Login/Logout Preferences](./Resources/Images/SingleSignOnSAML20OAuth20/SingleSignOnSAML20OAuth2.png)
...
4. **Export Service Provider Metadata**  
   ...
   ![Export Metadata](./Resources/Images/SingleSignOnSAML20OAuth20/SingleSignOnSAML20OAuth2_1.png)
...
5. **Configure Additional Settings**  
   ...
   - **Import Metadata From Identity Provider**: Uploads IdP-provided Entity ID, Redirect URL, and X.509 Certificate.  
     ![Import Metadata](./Resources/Images/SingleSignOnSAML20OAuth20/SingleSignOnSAML20OAuth2_2.png)  
   - **Set Login URL For SP-Initiated SSO**: Overrides Redirect URL with imported metadata.  
     ![SP-Initiated SSO](./Resources/Images/SingleSignOnSAML20OAuth20/SingleSignOnSAML20OAuth2_3.png)  
...
![Signature Settings](./Resources/Images/SingleSignOnSAML20OAuth20/SingleSignOnSAML20OAuth2_4.png)  
...
![Error Reports](./Resources/Images/SingleSignOnSAML20OAuth20/SingleSignOnSAML20OAuth2_5.png)  
...
![Multi-Tenant IDP](./Resources/Images/SingleSignOnSAML20OAuth20/SingleSignOnSAML20OAuth2_6.png)  
...
![Google SSO Setup](./Resources/Images/SingleSignOnSAML20OAuth20/SingleSignOnSAML20OAuth2_7.png)  
![Google SSO Login](./Resources/Images/SingleSignOnSAML20OAuth20/SingleSignOnSAML20OAuth2_8.png)  
...
![](./Resources/Images/SingleSignOnSAML20OAuth20/SingleSignOnSAML20OAuth2_9.png)
...
4.  Select the certificate.
    ...
    **Next**.
    ...
    ![](./Resources/Images/SingleSignOnSAML20OAuth20/SingleSignOnSAML20OAuth2_10.png)
...
![](./Resources/Images/SingleSignOnSAML20OAuth20/SingleSignOnSAML20OAuth2_11.png)
...
3.  For the **Configure Certificate** section, click the **Next** button
    ...
    ![](./Resources/Images/SingleSignOnSAML20OAuth20/SingleSignOnSAML20OAuth2_12.png)
...
4.  For the **Configure URL** section, check **Enable support for SAML
    ...
    **Login/Logout Preferences** widget.
    ...
    ![](./Resources/Images/SingleSignOnSAML20OAuth20/SingleSignOnSAML20OAuth2_13.png)
...
6.  In the **Configure Identifiers** section, you'll need to enter some
    ...
    ![](./Resources/Images/SingleSignOnSAML20OAuth20/SingleSignOnSAML20OAuth2_14.png)
...
6.  In the **Outgoing Claim Type** section, drop down and select **Name
    ...
    ![](./Resources/Images/SingleSignOnSAML20OAuth20/SingleSignOnSAML20OAuth2_15.png)
...
![](./Resources/Images/SingleSignOnSAML20OAuth20/SingleSignOnSAML20OAuth2_16.png)
...
![](./Resources/Images/SingleSignOnSAML20OAuth20/SingleSignOnSAML20OAuth2_17.png)

From the widget, select Add New to create a new tenant.

![](./Resources/Images/SingleSignOnSAML20OAuth20/SingleSignOnSAML20OAuth2_18.png)

![](./Resources/Images/SingleSignOnSAML20OAuth20/SingleSignOnSAML20OAuth2_19.png)
...
![](./Resources/Images/SingleSignOnSAML20OAuth20/SingleSignOnSAML20OAuth2_20.png)

### SAML 2.0 Flow

![](./Resources/Images/SingleSignOnSAML20OAuth20/SingleSignOnSAML20OAuth2_21.png)

### OAuth 2.0 Flow

![](./Resources/Images/SingleSignOnSAML20OAuth20/SingleSignOnSAML20OAuth2_22.png)